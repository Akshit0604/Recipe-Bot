...
const dalleUrl = 'https://example.com/dalle2-api'; // Replace with your DALL-E 2 API endpoint
...
function fetchBotReply(prompt) {
    fetch(openaiUrl, {
        ...
        generateRecipeImage(recipeText);
    }).catch(error => {
...
function generateRecipeImage(recipeText) {
    fetch(dalleUrl, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
